defmodule PortfolioWeb.Endpoint do
  ...
  # Serve documentation generated by ExDoc
  plug Plug.Static,
    at: "/docs",
    from: {:portfolio, "priv/static/docs"},
    gzip: false,
    only:
      ~w(index.html api-reference.html search.html dist portfolio.epub Portfolio.html PortfolioWeb.html),
    index: ["index.html"]
