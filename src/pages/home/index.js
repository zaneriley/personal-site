      ...
      <Layout hasHeader={false}>
        ...
        <div className={`${s.hero} ${g.gFlexContainer} ${g.gFlexCenter}`}>
          ...
          >
            ...
            <a href="mailto:hello@zaneriley.com?subject=Hey there" key={1}>
              <h2>hello@zaneriley.com</h2>
            </a>

            <h1 className={`${g.gMarginTopSmaller} ${g.g8m} `} key={2}>Digital product designer.</h1>

            <p className={` ${g.g6m} ${g.gMarginTop}`} key={3}>I’m Zane, a designer based in San Francisco, California. I make products easy to use and help businesses communicate more effectively. </p>
          ...
          <ReactCSSTransitionGroup
            ...
            transitionName={{
              enter: s.Zenter,
              enterActive: s.ZenterActive,
              leave: s.Zleave,
              leaveActive: s.ZleaveActive,
              appear: s.Zappear,
              appearActive: s.ZappearActive
            }}
            transitionAppear={true}
            transitionAppearTimeout={15000}
            transitionEnterTimeout={300}
