defmodule Portfolio.AdminFixtures do
  ...
  def case_study_fixture(attrs \\ %{}) do
    ...
    default_attrs = %{
      ...
      introduction:
        "Revolutionizing inventory management for a global e-commerce platform.",
      content:
        "TechCorp Solutions faced significant challenges with their legacy inventory system...",
