defmodule Portfolio.ContentTest do
  ...
  describe "update_case_study_from_file/1" do
    ...
    test "updates case study successfully from a valid Markdown file", %{case_study: case_study} do
      valid_file_path = "priv/case-study/en/testing-case-study.md"

      assert {:ok, updated_case_study} = Content.update_case_study_from_file(valid_file_path)
    ...
    test "returns error for missing file path" do
      assert capture_log(fn ->
        assert {:error, :file_path_missing} = Content.update_case_study_from_file(nil)
    ...
    test "returns error for missing delimiters in file" do
      ...
      assert capture_log(fn ->
             ...
             end) =~ "Error extracting content from file priv/case-study/en/testing-case-study-malformed.md. Reason: missing_frontmatter_delimiters"
    end
  end
end
