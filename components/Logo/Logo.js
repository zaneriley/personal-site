  ...
  render() {
    ...
    return (
      <a href="/" className={className + ` ${s.logo}`}>
        <svg width="40" height="40" version="1.1" x="0" y="0" viewBox="0 0 337.2 351.8" enableBackground="new 0 0 337.2 351.8">
          <pattern id="logoFill" width="1" height="1" viewBox="0 0 80 30" preserveAspectRatio="none"><image id="logoFillImage" xlinkHref="" width="80" height="30" preserveAspectRatio="none"></image></pattern>
          <pattern id="logoNormal" width="1" height="1" viewBox="0 0 80 30" preserveAspectRatio="none"><image id="logoNormalImage" xlinkHref="" width="80" height="30" preserveAspectRatio="none"></image></pattern>
