    ...
    return (
      <a href="/" className={className + ` ${s.logo}`}>
        <svg version="1.1" x="0" y="0" viewBox="0 0 337.2 351.8" enableBackground="new 0 0 337.2 351.8">
          ...
          <pattern id="logoNormal" width="1" height="1" viewBox="0 0 80 30" preserveAspectRatio="none"><image id="logoNormalImage" xlinkHref="http://i.imgur.com/fPDzIBV.png" width="80" height="30" preserveAspectRatio="none"></image></pattern>
